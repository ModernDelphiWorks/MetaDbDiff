@echo off
REM ---------------------------------------------------------------------------
REM FRENTE 14 - Schema-Aware Compare - build + test runner (Win32/Debug)
REM ---------------------------------------------------------------------------
setlocal
call "C:\Program Files (x86)\Embarcadero\Studio\37.0\bin\rsvars.bat"

set "DUnitX=C:\Program Files (x86)\Embarcadero\Studio\37.0\source\DUnitX"
set "WT=D:\Ecossistema-Axial\developer-friends-backend\.modules\MetaDbDiff\.claude\worktrees\agent-a1f76fb1ef0ad849f"
