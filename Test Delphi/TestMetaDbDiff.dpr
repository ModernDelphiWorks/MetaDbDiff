...
uses
  ...
  MetaDbDiff.Database.SnapshotCompare in '..\Source\Core\MetaDbDiff.Database.SnapshotCompare.pas',
  Test.MetaDbDiff.SequenceDiff in 'Test.MetaDbDiff.SequenceDiff.pas',
  MetaDbDiff.Compare.Options in '..\Source\Core\MetaDbDiff.Compare.Options.pas',
  MetaDbDiff.Metadata.Normalize in '..\Source\Core\MetaDbDiff.Metadata.Normalize.pas',
  Test.MetaDbDiff.Fakes in 'Test.MetaDbDiff.Fakes.pas',
  Test.MetaDbDiff.Sequencer in 'Test.MetaDbDiff.Sequencer.pas',
  Test.MetaDbDiff.AlterStrategy in 'Test.MetaDbDiff.AlterStrategy.pas',
  ...
  MetaDbDiff.DDL.AlterStrategy in '..\Source\Core\MetaDbDiff.DDL.AlterStrategy.pas',
