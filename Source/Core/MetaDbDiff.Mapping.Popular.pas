...
unit MetaDbDiff.Mapping.Popular;
...
begin
  ...
  { TODO -oISAQUE -cREFATORA��O :
    Foi alterado a propriedade do mapeamento para o mesmo tipo da declara��o
    dando assim mais recurso ao incluir novos tipos como foi o caso necess�rio
